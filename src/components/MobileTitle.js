            ...
            <div className="column">
              <div className="group-2410 flex-col">
                ...
                <div className="group-8510">
                  <p className="txt-562 overRight paddedOut" >Sign In</p>
                  <div className='column'>
                  <div id="Voxelland" className='bordered paddedOut Voxelland'>

              
              <a ><p className="txt-461 ">Voxelland</p></a>
              <div className='row'>
              ...
              <div>
              <a ><p className="txt-461 ">Pixelland</p></a>
              <div className='row'>
              <p className="txt-471 ">Unlock character</p>
              <p className="txt-035 ">Closed Beta !</p> 
              ...
              <div>
              <a><p className="txt-461 ">PixellandSaga</p></a>
              <div className='row'>
              <p className="txt-471 ">Unlock character</p>
              <p className="txt-035 ">Closed Beta !</p>
              </div>
